...
public class panalTest {

	public static void main(String[] args) {
		//그래픽 api 중 Panel 을 합습한다 판넬==판자떼기
		...
		//frame.add(bt); //개발자가 Border의 5가지 방향중 선택하지 않았을 경우 Default 방향은? CENTER 센터
		//결론 : 버튼은 혼자만 존재하기 때문에 북,동,서,남 의 모든 방위를 혼자 독차지함 따라서 대왕 버튼 등장
		...
		p.setBackground(Color.RED); //패널에 빨간색 배경 적용 / 컬러객체의 상수
